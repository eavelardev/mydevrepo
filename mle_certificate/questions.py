...
questions = [
    ...
    },
    {
        ...
        '* Using AI Platform Training requires preprocessing your data in a particular CSV structure and it is not ideal for fast iteration, as training times can take a long time because it cannot be distributed on multiple machines.',
        'references': []
    },
    {
        ...
        'answers': ['C'],
        'explanation': 'Video Intelligence API can find inappropriate components and other components satisfy the requirements of real-time processing and notification. AutoML Video intelligence should be only used in case of customization',
        'references': []
    },
    {
        'question': 'You need to build an object detection model for a small startup company to identify if and where the company’s logo appears in an image. You were given a large repository of images, some with logos and some without. These images are not yet labelled. You need to label these pictures, and then train and deploy the model. What should you do?',
        'tags': [4],
        'options': {
    ...
    # Certification Study Group - Professional Machine Learning Engineer (8 questions)
    {
        ...
        'answers': ['D'],
        'explanation': 'Considering the noise and fluctuations of the data, the moving average is more appropriate than min/max to show the trend.\n'
    ...
    {
        'question': 'You work for a maintenance company and have built and trained a deep learning model that identifies defects based on thermal images of underground electric cables. Your dataset contains 10,000 images, 100 of which contain visible defects. How should you evaluate the performance of the model on a test dataset?',
        'tags': [3],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'AUC measures how well predictions are ranked, rather than their absolute values. AUC is also classification-threshold invariant. It measures the quality of the model’s predictions irrespective of what classification threshold is chosen./n'
    ...
    {
        'question': 'Different cities in California have markedly different housing prices. Suppose you must create a model to predict the housing prices. Which of the following sets of features, or features crosses could learn city-specific relationships between roomsPerPerson and housing price?',
        'tags': [4],
        'options': {
    ...
    },
    {
        ...
        'answers': ['B'],
        'explanation': 'TPUs are not available for prediction on Vertex AI Endpoint (only GPUs).',
        'references': []
    },
    {
        'question': 'Your team is using a TensorFlow Inception-v3 CNN model pretrained on ImageNet for an image classification prediction challenge on 10,000 images. You will use AI Platform to perform the model training. What TensorFlow distribution strategy and AI Platform training job configuration should you use to train the model and optimize for wall-clock time?',
        'tags': [7],
        'options': {
    ...
    # Udemy - Google Cloud Machine Learning Engineer Certification Prep (50 questions)
    {
        'question': 'You are supporting a group of data analysts who want to build ML models using a managed service. They also want the ability to customize their models and tune hyperparameters.  What managed service in Google Cloud would you recommend?',
        'tags': [1, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'Vertex AI custom training allows for tuning hyperparameters. Vertex AI AutoML training tunes hyperparameters for you. BigQuery ML does not allow for hyperparameter tuning. Cloud TPUs are accelerators you can use to train large deep learning models.',
        'references': ['https://cloud.google.com/vertex-ai/docs/start/introduction-unified-platform']
    },
    {
        'question': 'You have created a Compute Engine instance with an attached GPU but the GPU is not used when you train a Tensorflow model. What might you do to ensure the GPU can be used for training your models?',
        'tags': [2, 'udemy'],
        'options': {
        ...
        'references': ['https://cloud.google.com/compute/docs/gpus/install-drivers-gpu']
    },
    {
        'question': 'A financial services company wants to implement a chatbot service to help direct customers to the best customer support team for their questions. What GCP service would you recommend?',
        'tags': [3, 'udemy'],
        'options': {
        ...
        'answers': ['D'],
        'explanation': 'Dialogflow is a service for creating conversational user interfaces. Speech-to-Text converts spoken words to written words. Text-to-Speech converts text words to human voice-like sound. AutoML Tables is a machine learning service for structured data.',
        'references': ['https://cloud.google.com/dialogflow/docs']
    },
    {
        'question': 'You lead a team of machine learning engineers working for an IoT startup. You need to create a machine learning model to predict the likelihood of a device failure in manufacturing environments. The device generates a stream of metrics every 60 seconds. The metrics include 2 categorical values, 7 integer values, and 1 floating point value. The floating point value ranges from 0 to 100.  For the purposes of the model, the floating point value is more precise than needed.  Mapping that value to a feature with possible values "high", "medium", and "low" is sufficient. What feature engineering technique would you use to transform the floating point value to high, medium, or low?',
        'tags': [4, 'udemy'],
        'options': {
            'A': 'L1 Regularization',
            'B': 'Normalization',
        ...
        'answers': ['C'],
        'explanation': 'The correct answer is bucketing. In this case, values from 0 to 33 could be low, 34 to 66 could be medium, and values greater than 66 could be high. Regularization is the limiting of information captured by a model to prevent overfishing; L1 and L2 are two examples of regularization techniques.Normalization is a transformation that scales numeric values to the range 0 1o 1.',
        'references': []
    },
    {
        'question': 'You have trained a machine learning model. After training is complete, the model scores high on accuracy and F1 score when measured using training data; however, when validation data is used, the accuracy and F1 score l are much lower.  What is the likely cause of this problem?',
        'tags': [5, 'udemy'],
        'options': {
            'A': 'Overfitting',
            'B': 'Underfitting',
    ...
    {
        'question': "You are building a machine learning model using random forests. You haven't achieved the precision and recall you would like. What hyperparameter or hyperparameters would you try adjusting to improve accuracy?",
        'tags': [6, 'udemy'],
        'options': {
    ...
    },
    {
        ...
        'answers': ['B'],
        'explanation': 'AutoML Tables uses structured data to build models with little input from users.  Spark ML and Tensorflow is suitable for modelers with programming skills. There is no Bigtable ML but BigQuery ML is a managed service for building machine learning models in BigQuery using SQL.',
        'references': []
    },
    {
        'question': 'When testing a regression model to predict the selling price of houses.  After several iterations of model building, you note that small changes in a few features can lead to large differences in the output. This is an example of what kind of problem?',
        'tags': [8, 'udemy'],
        'options': {
            'A': 'Low variance',
            'B': 'High variance',
        ...
        'answers': ['B'],
        'explanation': 'This is an example of high variance.  High bias occurs when relationships are missed. Low bias and low variance are desired in ML models and are not a problem.',
        'references': []
    },
    {
        'question': 'You are an ML engineer with a startup building machine learning models for the pharmaceutical industry. You are currently developing a deep learning machine learning model to predict the toxicity of drug candidates. The training data set consists of a large number of chemical and physical attributes and there is a large number of instances.  Training takes several days on an n2 type Compute Engine virtual machine.  What would you recommend to reduce the training time without compromising the quality of the model?',
        'tags': [9, 'udemy'],
        'options': {
            'A': 'Use TPUs',
    ...
    },
    {
        ...
        'answers': ['A'],
        'explanation': 'Area under the ROC curve (AUC) is a graph of True Positive and False Positive rates.  Precision is a measure of the quality of positive predictions. F1 Score is a harmonic mean of precision and recall.  L2 Regularization is a technique to prevent overfitting.',
        'references': []
    },
    {
        'question': 'You are building a machine learning model and during the data preparation stage, you preform normalization and standardization using the full data set. You then split the full data set into training, validation, and testing data sets. What problem could be introduced by performing the steps in the order described?',
        'tags': [11, 'udemy'],
        'options': {
            'A': 'Regularization',
            'B': 'Data leakage',
    ...
    {
        'question': 'A simple model based on hand-coded heuristics or a simple algorithms such as a linear model is often built early in the model training process. What is the purpose of such as model?',
        'tags': [12, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'It provides a baseline for the minimum performance to expect in an ML model. Simple models do not provide indication of maximum performance. A simple model could underfit and would be expected. Simple models are not likely to overfit.',
        'references': []
    },
    {
        'question': 'What characteristics of feature values do we try to find when using descriptive statistics for data exploration?',
        'tags': [13, 'udemy'],
        'options': {
        ...
        'answers': ['C'],
        'explanation': 'Descriptive statistics are used to measure both central tendency and the spread of values.  The likelihood of contributing to a prediction is not measured until after a model is created.',
        'references': []
    },
    {
        'question': 'You are building a classification model to detect fraud in credit card transactions. When exploring the training data set you notice that 2% of instances are examples of fraudulent transactions and 98% are legitimate transactions. This is an example of what kind of data set?',
        'tags': [14, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'This is an imbalnaced data set because one class has significantly more instances than the others.  Standardization and normalization are techniques for preparing the data set. There is no such thing as a marginalized data set in machine learning.',
        'references': []
    },
    {
        'question': 'Which of the following techniques can be used when working with imbalanced data sets?',
        'tags': [15, 'udemy'],
        'options': {
        ...
        'answers': ['D'],
        'explanation': 'Collecting  more data, generating synthetic data, and resampling are all techniques for working with imbalanced data sets.',
        'references': []
    },
    {
        'question': 'A team of machine learning engineers is training an image recognition model to detect defects in manufactured parts. The team has a data set of 10,000 images but wants to train with at least 30,000 images. They do not have time to wait for an additional set of 20,000 images to be collected on the factory floor. What type of technique could they use to produce a data set with 30,000 images?',
        'tags': [16, 'udemy'],
        'options': {
            'A': 'Normalization',
            'B': 'Data augmentation',
    ...
    },
    {
        ...
        'answers': ['A'],
        'explanation': 'Parameter servers store model parameters and share state.  Evaluators evaluate models while primary replicas manage other nodes. There is no state servers.',
        'references': []
    },
    {
        'question': 'A dataset includes multiple categorical values. You want to train a deep learning neural network using the data set. Which of the following would be an appropriate data encoding scheme?',
        'tags': [18, 'udemy'],
        'options': {
            'A': 'One-hot encoding',
        ...
        'answers': ['A'],
        'explanation': 'One-hot encoding is an appropriate encoding technique to map categorical values to a bit vector. Categorical values themselves are not suitable input to a deep learning network. Regularization is is used to prevent overfitting. Normalization is a data preparation operation.',
        'references': []
    },
    {
        'question': 'A dataset you are using has categorical values mapped to integer values, such as red to 1, blue to 2, and green to 3. What kind of encoding scheme is this?',
        'tags': [19, 'udemy'],
        'options': {
            'A': 'One-hot encoding',
            'B': 'Feature hashing',
        ...
        'answers': ['C'],
        'explanation': 'This is an example of ordinal encoding.  One-hot encoding maps to a bit vector with only one bit set to one. Feature hashing applies a hash function to compute a representation. Data augmentation is not an encoding scheme, it is a set of techniques for increasing the size of a data set.',
        'references': []
    },
    {
        'question': 'Which of the following are ways bias can be introduced in a machine learning model? (Choose 2)',
        'tags': [20, 'udemy'],
        'options': {
    ...
    },
    {
        ...
        'answers': ['C'],
        'explanation': 'A feature cross could capture the non-linear relationship. A deep learning network can also learn non-linear relationships but they require large volumes of data. Regularization is a set of techniques for preventing overfitting. Data leakage is unwanted in a machine learning model.',
        'references': []
    },
    {
        'question': 'You have a dataset with more features than you believe you need to train a model. You would like to measure how well two numerical values linearly correlate so you can eliminate one of them if they highly correlate. What statistical test would you use?',
        'tags': [22, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': "The Pearson's Correlation is used for measuring the linear correlation between two variables. ANOVA is used to measure the difference among means.  Kendall's Rank Coefficient is used for measuring numeric and categorical correlations. The Chi-Squared test is used for measuring the correlation between categorical values.",
        'references': []
    },
    {
        'question': 'You have a dataset with more features than you believe you need to train a model. You would like to measure how well two categorical values linearly correlate so you can eliminate one of them if they highly correlate. What statistical test would you use?',
        'tags': [23, 'udemy'],
        'options': {
            'A': "Pearson's Correlation",
            'B': 'ANOVA',
        ...
        'answers': ['C'],
        'explanation': "The Chi-Squared test is used for measuring the correlation between categorical values. Pearson's Correlation is used for measuring the linear correlation between two variables. ANOVA is used to measure the difference among means.  Kendall's Rank Coefficient is used for measuring numeric and categorical correlations.",
        'references': []
    },
    {
        'question': 'Which of the following types of pre-built containers are available in Vertex AI? (Choose 3)',
        'tags': [24, 'udemy'],
        'options': {
        ...
        'answers': ['A', 'D', 'E'],
        'explanation': 'TensorFlow Optimized Runtime, XGBoost, and Scikit-Learn are available in Vertex AI pre-built containers. Hadoop Mahout and Theano are machine learning platforms but not available as pre-built containers.',
        'references': []
    },
    {
        'question': 'Which of the following are required of a custom container used with Vertex AI? (Choose 2)',
        'tags': [25, 'udemy'],
        'options': {
        ...
        'answers': ['A', 'C'],
        'explanation': 'Custom container images running in Vertex AI must have an HTTP server as well as support health checks and liveliness checks.  Request and response message sizes must be 1.5MB or less. Support for GPUs or TPUs is not required.',
        'references': []
    },
    {
        'question': 'You are training large deep learning networks in Kubernetes Engine and want to use a cost-effective accelerator. You do not need high precision floating point operations. What would you choose?',
        'tags': [26, 'udemy'],
        'options': {
            'A': 'GPUs',
            'B': 'TPUs',
        ...
        'answers': ['B'],
        'explanation': 'You are training large deep learning networks in Kubernetes Engine and want to use a cost-effective accelerator. You do not need high precision floating point operations. What would you choose?',
        'references': []
    },
    {
        'question': 'Several datasets you use for training ML models have missing data. You consider deleting rows with missing data. In which case would you not want to delete instances with missing data?',
        'tags': [27, 'udemy'],
        'options': {
    ...
    },
    {
        ...
        'answers': ['D'],
        'explanation': 'These are all examples of hyperparameters to machine learning models.',
        'references': []
    },
    {
        'question': 'You are validating a machine learning model and have decided you need to further tune hyperparamets. You would like to try analyze multiple hyperparameter combinations in parallel. Which of the following techniques could you use?',
        'tags': [30, 'udemy'],
        'options': {
        ...
        'answers': ['B'],
        'explanation': 'Random search and grid search can both be applied in parallel. Bayesian search is a sequential method for searching hyperparameter combinations.',
        'references': []
    },
    {
        'question': 'You spend a lot of time tuning hyperparameters by manually testing combinations of hyperparameters. You want to automate the process and use a technique that can learn from previous evaluations of other hyperparameter combinations. What algorithm would you use?',
        'tags': [31, 'udemy'],
        'options': {
            'A': 'Grid search',
            'B': 'Data augmentation',
        ...
        'answers': ['C'],
        'explanation': 'Bayesian search uses knowledge from previous evaluations when selecting new hyperparameter values. Grid search and random search are used for hyperparameter tuning but do not use prior knowledge. Data augmentation is not used for searching hyperparameters.',
        'references': []
    },
    {
    ...
    },
    {
        ...
        'answers': ['A'],
        'explanation': 'Feature vectors are the standard way of inputting data to a machine learning algorithm. Lists of categorical values are not accessible to many machine learning algorithms.  2-dimensional and 3-dimensional arrays are mapped to 1-dimensional feature vectors before submitting data to the machine learning training algorithm.',
        'references': []
    },
    {
        'question': 'An IoT company has developed a TensorFlow deep learning model to detect anomalies in machine sensor readings. The model will be deployed to edge devices. Machine learning engineers want to reduce the model size without significantly reducing the quality of the model. What technique could they use?',
        'tags': [36, 'udemy'],
        'options': {
            'A': 'ANOVA',
            'B': 'Quantization',
        ...
        'answers': ['B'],
        'explanation': 'Quantization is a technique for reducing model size without reducing quality. ANOVA is a statistical test for comparing the means of two or more populations.  Data augmentation is used to create new training instances based on existing instances.  Bucketing is a technique of mapping feature values into a smaller set of values.',
        'references': []
    },
    {
        'question': 'You have created a machine learning model to identify defective parts in an image. Users will send images to an endpoint used to serve the model. You want to follow Google Cloud recommendations. How would you encode the image when making a request of the prediction service?',
        'tags': [37, 'udemy'],
        'options': {
            'A': 'CSV',
            'B': 'Avro',
        ...
        'answers': ['C'],
        'explanation': 'Base64 is the recommended encoding for images.  CSV and Avro are file formats for structured data. Capacitor format is used by BigQuery to store data in compressed, columnar format.',
        'references': []
    },
    {
        'question': 'You are making a large number of predictions using an API endpoint.  Several of the services making requests could send batches of requests instead of individual requests to the endpoint.  How could you improve the efficiency of serving predictions?',
        'tags': [38, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'Using batches with large batch size will take advantage of vectorization and improve efficiency.  Vertically scaling will increase throughput but using the API and single requests will still use more compute resources than using batch processing. Training with additional data or re-training more frequently will not change serving efficiency.',
        'references': []
    },
    {
        'question': 'Which component of the Vertex AI platform provides for the orchestration of machine learning operations in Vertex AI?',
        'tags': [39, 'udemy'],
        'options': {
        ...
        'answers': ['B'],
        'explanation': 'Vertex AI Pipelines provides orchestration in Vertex AI.  Vertex AI Prediction is for serving models, Vertex AI Experiments is for tracking training experiments, and Vertex AI Workbench provides managed and user managed notebooks for development.',
        'references': []
    },
    {
        'question': 'A team of researchers have built a TensorFlow model for predicting near-term weather changes. They are using TPUs but are not achieving the throughput they would like. Which of the following might improve the efficiency of processing?',
        'tags': [40, 'udemy'],
        'options': {
        ...
        'answers': ['A'],
        'explanation': 'Using the tf.data API to maximize the efficiency of data pipelines using GPUs and TPUs is the correct answer.  XGBoost is another machine learning platform and will not improve the efficiency of a TensorFlow model. Early stopping is an optimization for training, not serving.  Scaling up CPUs or adding more CPUs will not significantly change the efficiency of using GPUs or TPUs.',
        'references': []
    },
    {
        'question': 'Managed data sets in Vertex AI provided which of the following benefits?',
        'tags': [41, 'udemy'],
        'options': {
        ...
        'answers': ['B'],
        'explanation': 'The correct answer is managed data sets in a central location and create labels and annotations only.  There are no enhanced predefined roles for Vertex AI datasets.',
        'references': []
    },
    {
        'question': 'Which of the following are options for tabluar datasets in Vertex AI Datasets?',
        'tags': [42, 'udemy'],
        'options': {
            'A': 'CSV files only',
        ...
        'answers': ['B'],
        'explanation': 'Vetext AI Datasets support CSV files and BigQuery tables and views for tabular data.  Bigtable tables and Avro files are not supported.',
        'references': []
    },
    {
        'question': 'A team of reviewers is analyzing a training data set for sensitive information that should not be used when training models. Which of the following are types of sensitive information that should be removed from the training set?',
        'tags': [43, 'udemy'],
        'options': {
        ...
        'answers': ['A', 'B', 'D'],
        'explanation': 'Credit card numbers, government ID numbers, and faces in images are all examples of sensitive information. Purchase history and customer segment identifiers are not sensitive information.',
        'references': []
    },
    {
        'question': 'Which of the follwoing techniques can be used to mask sensitive data?',
        'tags': [44, 'udemy'],
        'options': {
        ...
        'answers': ['A', 'B', 'E'],
        'explanation': 'Substitution cipher, tokenization, and principal component analysis can all be used to mask sensitive data. Data augmentation is used to increase the size of training sets. Regularization is used to prevent overfitting.',
        'references': []
    },
    {
        'question': 'Which of the following is a type of security risk to machine learning model?',
        'tags': [45, 'udemy'],
        'options': {
            'A': 'Data poisoning',
            'B': 'Missing data',
        ...
        'answers': ['A'],
        'explanation': 'Data poisoning is a security risk associated with an attacker compromising the training process in order to train the model to behave in ways the attacker wants.  Missing data and inconsistent data are data risks that can compromise a model but they are not security risks. Insufficiently agreed upon objectives is a process risk but not a security risk.',
        'references': []
    },
    {
        'question': 'You are training a classifier using XGBoost in Vertex AI.  Training is proceeding slower than expected so you add GPUs to your training server.  There is no noticeable difference in the training time. Why is this?',
        'tags': [46, 'udemy'],
        'options': {
        ...
        'answers': ['C'],
        'explanation': 'Using TPUs would not improve performance either. GPUs are useful for improving training performance. Vertex AI manages images used for training and serving so there is no need to manually install GPU drivers.',
        'references': []
    },
    {
        'question': 'Aerospace engineers are building a model to predict turbulence and impact on a new airplane wing design. They have large, multi-dimensional data sets. What file format would you recommend they use for training data?',
        'tags': [47, 'udemy'],
        'options': {
            'A': 'Parquet',
            'B': 'Petastorm',
        ...
        'answers': ['B'],
        'explanation': 'Petastorm is designed for multi-dimensional data. Parquet and ORC are both columnar formats and could be used but Petastorm is a better option. CSV is inefficient for large data sets.',
        'references': []
    },
    {
        'question': 'You would like to use a nested file format for training data that will be used with TensorFlow. You would like to use the most efficient format. Which of the following would you choose?',
        'tags': [48, 'udemy'],
        'options': {
            'A': 'JSON',
            'B': 'XML',
        ...
        'answers': ['D'],
        'explanation': 'TFRecords is based on protobuf, a binary nested file format and optimized for TensorFlow.  JSON and XML are plain text formats and not as efficient as TFRecord.  CSV is not a nested file format.',
        'references': []
    },
    {
        'question': 'A robotics developer has created a machine learning model to detect unripe apples in images. Robots use this information to remove unripe apples from a conveyor belt.  The engineers who developed this model are using it as a starting model for training a model to detect unripe pears.  This is an example of what kind of learning?',
        'tags': [49, 'udemy'],
        'options': {
        ...
        'answers': ['D'],
        'explanation': 'This is an example of transfer learning.  Unsupervised learning uses data sets without labels.  Regression models predict a continuous value.  Reinforcement learning uses feedback from the environment to learn.',
        'references': []
    },
    {
        'question': 'A retailer has deployed a machine learning model to predict when a customer is likely to abandon a shopping cart. A MLOps engineer notices that the feature data distribution in production deviates from feature data distribution in the latest training data set.  This is an example of what kind of problem?',
        'tags': [50, 'udemy'],
        'options': {
            'A': 'Skew',
            'B': 'Drift',
    ...
    ## whizlabs - Google Cloud Certified Professional Machine Learning Engineer - Practice Test 1
    {
        ...
        'references': ['https://developers.google.com/machine-learning/crash-course/regularization-for-simplicity/l2-regularization', 'https://developers.google.com/machine-learning/crash-course/images/RegularizationTwoLossFunctions.svg']
    },
    {
        'question': 'You need to develop and train a model capable of analyzing snapshots taken from a moving vehicle and detecting if obstacles arise. Your work environment is Vertex AI.\n'
        ...
        'references': ['https://github.com/tensorflow/models/tree/master/research/object_detection', 'https://cloud.google.com/vertex-ai/docs/training/training', 'https://cloud.google.com/ai-platform/training/docs', 'https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/img/kites_detections_output.jpg']
    },
    {
    ...
    },
    {
        ...
        'references': ['https://towardsdatascience.com/convolution-neural-networks-a-beginners-guide-implementing-a-mnist-hand-written-digit-8aa60330d022', 'https://research.google.com/pubs/archive/42455.pdf']
    },
    {
        'question': 'The purpose of your current project is the recognition of genuine or forged signatures on checks and documents against regular signatures already stored by the Bank. There is obviously a very low incidence of fake signatures. The system must recognize which customer the signature belongs to and whether the signature is identified as genuine or skilled forged.\n'
        ...
        'references': ['https://towardsdatascience.com/convolution-neural-networks-a-beginners-guide-implementing-a-mnist-hand-written-digit-8aa60330d022']
    },
    {
        'question': 'Your client has a large e-commerce Website that sells sports goods and especially scuba diving equipment. It has a seasonal business and has collected many sales data from its structured ERP and market trend databases. It wants to predict the demand of its customers both to increase business and improve logistics processes.\n'
    ...
    {
        'question': 'Your team is designing a fraud detection system for a major Bank. The requirements are:\n'
    ...
    {
        'question': 'In your company, you train and deploy several ML models with Tensorflow. You use on-prem servers, but you often find it challenging to manage the most expensive training and control and update the models. You are looking for a system that can handle all these tasks.\n'
    ...
    {
        'question': "You have an NLP model for your company's Customer Care and Support Office. This model evaluates the general satisfaction of customers on the main categories of services offered and has always provided satisfactory performances.\n"
    ...
    {
        'question': 'Your company is designing a series of models aimed at optimal customer care management.\n'
        ...
        'references': ['https://cloud.google.com/architecture/sensitive-data-and-ml-datasets']
    },
    {
        'question': 'Your team is working for a major apparel company that is developing an online business with significant investments.\n'
        ...
        'answers': ['A', 'E'],
        'explanation': 
        'It is necessary to create different groups of customers based on purchases and their characteristics for these requirements./n'
    ...
    {
        'question': 'Your team prepared a custom model with Tensorflow that forecasts, based on diagnostic images, which cases need more analysis and medical support.\n'
    ...
    {
        'question': 'You have an ML model designed for an industrial company that provides the correct price to buy goods based on a series of elements, such as the quantity requested, the level of quality and other specific variables for different types of products.\n'
    ...
    },
    {
        ...
        'references': ['https://en.wikipedia.org/wiki/Bias%E2%80%93variance_tradeoff']
    },
    {
        'question': 'Your company supplies environmental management services and has a network of sensors that acquire information uploaded to the Cloud to be pre-processed and managed with some ML models with dynamic dashboards used by customers.\n'
    ...
    {
        'question': 'TerramEarth is a company that builds heavy equipment for mining and agriculture.\n'
    ...
    {
        'question': 'Your company does not have an excellent ML experience. They want to start with a service that is as smooth, simple and managed as possible. The idea is to use BigQuery ML. Therefore, you are considering whether it can cover all the functionality you need.\n'
    ...
    {
        'question': "Your business makes excellent use of ML models. Many of these were developed with Tensorflow. But lately, you've been making good use of AutoML to make your design work leaner, faster, and more efficient.\n"
    ...
    {
        'question': 'You are a junior Data Scientist. You need to create a multi-class classification Machine Learning model with Keras Sequential model API. In particular, your model must indicate the main categories of a text.\n'
        ...
        'answers': ['C'],
        'explanation': 'The answers identify the main techniques to be used for a multi-class classification Machine Learning model. For more details, see the step-by-step example.\n'
    ...
    {
        'question': 'You work for a digital publishing website with an excellent technical and cultural level, where you have both famous authors and unknown experts who express ideas and insights.\n'
    ...
    },
    {
        ...
        'references': ['https://en.wikipedia.org/wiki/Feedforward_neural_network']
    },
    {
    ...
    {
        'question': 'You work for a video game company. Your management came up with the idea of creating a game in which the characteristics of the characters were taken from those of the human players. You have been asked to generate not only the avatars but also various visual expressions during the game actions.',
        'tags': [32, 'whizlabs1'],
        'options': {
            'A': 'Feedforward Neural Network',
            'B': 'Convolutional Neural Network',
    ...
    {
        'question': 'You are starting to operate as a Data Scientist and are working on a model of prizes optimization with products with a lot of categorical features. You don’t know how to deal with them. Your manager told you that you had to encode them in a limited set of numbers.\n'
    ...
    {
        'question': "You are a Data Scientist, and you work in a large organization. A fellow programmer, who is working on a project with Dataflow, asked you what the GCP techniques support the computer's ability to entertain almost human dialogues and if these techniques can be used individually.\n"
    ...
    {
        'question': 'You are working on a deep neural network model with Tensorflow on a cluster of VMs for a Bank. Your model is complex, and you work with huge datasets with complex matrix computations.\n'
    ...
    {
        'question': 'You are working with a Linear Regression model for an important Financial Institution. Your model has many independent variables. You discovered that you could not achieve good results because many variables are correlated. You asked for advice from an experienced Data scientist that explains what you can do.\n'
    ...
    {
        'question': 'You are using Vertex AI, with a series of demanding training jobs. So, you want to use TPUs instead of CPUs. You are not using Docker images or custom containers.\n'
    ...
    {
        'question': 'You are training a set of modes that should be simple, using regression techniques. During training, your model seems to work. But the tests are giving unsatisfactory results. You discover that you have several wrongs and missing data. You need a tool that helps you cope with them.\n'
    ...
    {
        'question': 'You are a junior Data Scientist, and you are being interviewed for a new job.\n'
    ...
    {
        'question': 'Your company operates an innovative auction site for furniture from all times. You have to create a series of ML models that allow you to establish the period, style and type of the piece of furniture depicted starting from the photos. Furthermore, the model must be able to determine whether the furniture is interesting and require it to be subject to a more detailed estimate. You created the model, but your manager said that he wants to supply this service to mobile users when they go to the fly markets.\n'
        'Which of the following services do you think is the most suitable?',
        'tags': [46, 'whizlabs1'],
        'options': {
            'A': 'AutoML Vision Edge',
    ...
    {
        'question': 'You are training a set of modes that should be simple, using regression techniques. During training, your model seems to work. But the tests are giving unsatisfactory results. You discover that you have several missing data. You need a tool that helps you cope with them.\n'
    ...
    {
        'question': 'In your company you use Tensorflow and Keras as main libraries for Machine Learning and your data is stored in disk files, so block storage.\n'
    ...
    {
        'question': 'You are a junior Data Scientist. You are working with a linear regression model with sklearn.\n'
    ...
    {
        'question': 'Your team is designing a financial analysis model for a major Bank.\n'
    ...
    {
        'question': 'You are starting to operate as a Data Scientist and are working on a deep neural network model with Tensorflow to optimize the level of customer satisfaction for after-sales services with the goal of creating greater client loyalty.\n'
        ...
        'Vertex AI is a suite of services that combines AutoML and AI Platform - you can use both AutoML training and custom training in the same environment.',
        'references': [
    ...
    {
        'question': 'You have a customer ranking ML model in production for an e-commerce site; the model used to work very well.\n'
    ...
    {
        'question': 'You have a customer ranking ML model in production for an e-commerce site; the model used to work very well. You use GCP managed services, specifically Vertex AI. Suddenly there is a sensible degradation in the quality of the inferences. You perform various checks, but the model seems to be perfectly fine.\n'
    ...
    {
        'question': 'Your company runs an e-commerce site. You produced static deep learning models with Tensorflow that process Analytics-360 data. They have been in production for some time. Initially, they gave you excellent results, but then gradually, the accuracy has decreased.\n'
    ...
    {
        'question': 'Your company runs a big retail website. You develop many ML models for all the business activities. You migrated to Google Cloud when you were using Vertex AI. Your models are developed with PyTorch, TensorFlow and BigQueryML.\n'
    ...
    {
        'question': 'You are a Data Scientist and working on a project with PyTorch. You need to save the model you are working on because you have to cope with an urgency. You, therefore, need to resume your work later.\n'
    ...
    {
        'question': 'You are a Data Scientist. You are going to develop an ML model with Python. Your company adopted GCP and Vertex AI, but you need to work with your developing tools.\n'
    ...
    {
        'question': 'You work as a Data Scientist for a major banking institution that recently completed the first phase of migration in GCP.\n'
    ...
    {
        'question': 'You work as a Data Scientist in a Startup. You want to create an optimized input pipeline to increase the performance of training sessions, avoiding GPUs and TPUs as much as possible because they are expensive.\n'
        'Which technique or algorithm do you think is best to use?',
        'tags': [9, 'whizlabs2'],
        'options': {
            'A': 'Caching',
    ...
    {
        'question': 'You are working on a new model together with your client, a large financial institution. The data you are dealing with contains PII (Personally Identifiable Information) contents.\n\n'
    ...
    {
        'question': 'You are a junior Data Scientist and working on a deep neural network model with Tensorflow to optimize the level of customer satisfaction for after-sales services to create greater client loyalty.\n'
    ...
    {
        'question': 'You work for an important organization. Your manager tasked you with a new classification model with lots of data drawn from the company Data Lake.\n'
    ...
    {
        'question': 'Your company runs an e-commerce site. You manage several deep learning models with Tensorflow that process Analytics-360 data, and they have been in production for some time. The modeling is made essentially with customers and orders data. You need to classify many business outcomes.\n'
    ...
    {
        'question': 'Your team works for a startup company with Google Cloud. You develop, train and deploy several ML models with Tensorflow. You use data in Parquet format and need to manage it both in input and output. You want the smoothest solution without adding infrastructure and keeping costs down.\n'
    ...
    {
        'question': 'You are starting to operate as a Data Scientist and speaking with your mentor who asked you to prepare a simple model with a lazy learning algorithm.\n'
    ...
    {
        'question': 'Your company traditionally deals with the statistical analysis of data. The services have been integrated with ML models for forecasting for some years, but analyzes and simulations of all kinds are carried out.\n'
    ...
    {
        'question': 'Your team works for an international company with Google Cloud. You develop, train and deploy different ML models. You use a lot of tools and techniques and you want to make your work leaner, faster and more efficient.\n'
    ...
    {
        'question': 'You work in a large company that produces luxury cars. The following models will have a control unit capable of collecting data on mileage and technical status to allow intelligent management of maintenance by both the customer and the service centers.\n'
    ...
    {
        'question': 'Your company does not have a great ML experience. Therefore they want to start with a service that is as smooth, simple and managed as possible.\n'
    ...
    {
        'question': 'Your team is working on a great number of ML projects.\n'
    ...
    {
        'question': 'Your team is preparing a Deep Neural Network custom model with Tensorflow in Vertex AI that forecasts, based on diagnostic images, medical diagnoses. It is a complex and demanding job. You want to get help from GCP for hyperparameter tuning.\n'
        ...
        'answers': ['A', 'D'],
        'explanation': 'With Vertex AI, it is possible to create a hyperparameter tuning job for LINEAR_REGRESSION and DNN.\n'
    ...
    {
        'question': 'Your team needs to create a model for managing security in restricted areas of campus.\n'
    ...
    {
        'question': "You are consulting a CIO of a big firm regarding organization and cost optimization for his company's ML projects in GCP.\n"
    ...
    {
        'question': 'Your team is working with a great number of ML projects, especially with Tensorflow.\n'
    ...
    {
        'question': 'You are working on a linear regression model with data stored in BigQuery. You have a view with many columns. You want to make some simplifications for your work and avoid overfitting. You are planning to use regularization. You are working with Bigquery ML and preparing the query for model training. You need an SQL statement that allows you to have all fields in the view apart from the label.\n'
    ...
    {
        'question': 'Your team is preparing a multiclass logistic regression model with tabular data.\n'
    ...
    {
        'question': 'You are a junior Data Scientist, and you work in a Governmental Institution.\n'
    ...
    {
        'question': 'You are a junior Data Scientist and you need to create a multi-class classification Machine Learning model with Keras Sequential model API.\n'
    ...
    {
        'question': 'Your team is working on a great number of ML projects for an international consulting firm.\n'
    ...
    {
        'question': 'Your team has prepared a Multiclass logistic regression model with tabular data in the Vertex AI with Auto ML environment. Everything went very well. You appreciated the convenience of the platform and AutoML.\n'
    ...
    {
        'question': 'With your team, you have to decide the strategy for implementing an online forecasting model in production. This template needs to work with both a web interface as well as DialogFlow and Google Assistant. A lot of requests are expected.\n'
        ...
        'Kubeflow is not a managed service. It is used in AI platforms and lets you deploy ML systems in various environments.',
        'references': [
    ...
    {
        'question': 'You work in a medium-sized company as a developer and data scientist and use the managed ML platform, Vertex AI.\n'
    ...
    {
        'question': 'You and your team are working for a large consulting firm. You are preparing an NLP ML model to classify customer support needs and to assess the degree of satisfaction. The texts of the various communications are stored in different storage.\n'
    ...
    {
        'question': 'You are working with Vertex AI, the managed ML Platform in GCP.\n'
    ...
    {
        'question': 'You work as a junior Data Scientist in a Startup and work with several projects with Python and Tensorflow in Vertex AI. You deployed a new model in the test environment and detected some problems that are puzzling you.\n'
        ...
        'answers': ['A', 'D'],
        'explanation': 'In Vertex AI, you may enable or avoid logs for prediction. When you want to change, you must undeploy and redeploy.\n'
    ...
    {
        'question': 'You are a junior Data Scientist working on a logistic regression model to break down customer text messages into two categories: important / urgent and unimportant / non-urgent.\n'
    ...
    {
        'question': 'In your company, you train and deploy several ML models with Tensorflow. You use on-prem servers, but you often find it challenging to manage the most expensive training.\n'
    ...
    {
        'question': 'Your company runs a big retail website. You develop many ML models for all the business activities.\n'
    ...
    {
        'question': 'Your company is a Financial Institution. You develop many ML models for all the business activities. You migrated to Google Cloud. Your models are developed with PyTorch, TensorFlow, and BigQueryML.\n'
    ...
    {
        'question': "You are a junior data scientist working on a logistic regression model to break down customer text messages into important/urgent and important / not urgent. You want to use the best loss function that you can use to determine your model's performance.\n"
        'Which of the following is the optimal methodology?',
        'tags': [48, 'whizlabs2'],
        'options': {
            'A': 'Log Loss',
    ...
    {
        'question': 'You have just started working as a junior Data Scientist in a Startup. You are involved in several projects with Python and Tensorflow in Vertex AI.\n'
    ...
    },
    {
        ...
        'answers': ['A', 'B', 'D'],
        'explanation': 'Deep Learning is known to give little comprehension about how a model works in detail.\n'
        'Vertex Explainable AI helps to detect it, both for classification and regression tasks. So, these functions are useful for testing, tuning, finding biases and thus improving the process.\n'
        'It uses three methods for feature attributions:\n'
        '* sampled Shapley: Uses scores for each feature and their permutations\n'
    ...
    {
        'question': 'Your company produces and sells a lot of different products.\n'
    ...
    },
    {
        ...
        'answers': ['B', 'D'],
        'explanation': 'You can export a Dataset; when you do that, no additional copies of data are generated. The result is only JSONL files with all the useful information, including the Cloud Storage files URIs.\n'
    ...
    {
        'question': 'You work as a junior Data Scientist in a consulting company, and you work with several ML projects.\n'
    ...
    {
        'question': 'You just started working as a junior Data Scientist in a consulting Company. You are in a project team that is building a new model and you are experimenting. But the results are absolutely unsatisfactory because your data is dirty and needs to be modified.\n'
    ...
    {
        'question': 'You just started working as a junior Data Scientist in a consulting Company.\n'
