...
questions = [
    ...
    },
    {
        ...
        'answers': ['A'],
        'explanation':
        'AUC measures how well predictions are ranked, rather than their absolute values. AUC is also classification-threshold invariant. It measures the quality of the model’s predictions irrespective of what classification threshold is chosen./n'
    ...
    },
    {
        ...
        'answers': ['A'],
        'explanation':
        "The Pearson's Correlation is used for measuring the linear correlation between two variables. ANOVA is used to measure the difference among means.  Kendall's Rank Coefficient is used for measuring numeric and categorical correlations. The Chi-Squared test is used for measuring the correlation between categorical values.",
        'references': []
    },
    {
        'question':
